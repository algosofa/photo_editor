...
for i in range(5):
    monster = Enemy(img_enemy, randint(80, 620), -40, 80, 50, randint(1, 10))
...
while run:
    ...
    if not finish:
        ...
        #выигрыш)
        if score >= 10: #тут свою цифру пишем
            finish = True
            window.blit(win, (200, 200))

        #проигрыш(
        if life == 0 or lost >= max_lost: #либо свою цифру
            finish = True
            window.blit(lose, (200, 200))

        text_life = font1.render(str(life), 1, (208, 0, 255))
